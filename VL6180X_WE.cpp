 ...
 * ----------------------------------------
 * Eigene Änderungen vorgenommen und Kommentare ergänzt! Wolle, Aug, 2018
 * ----------------------------------------
...
uint8_t VL6180x::getDistanceContinously()
{
  ...
  VL6180x_setRegister(VL6180X_SYSRANGE_START, 0x03); //Start Single shot mode (=0x01)  //ACHTUNG!!!!!!!!!!!!! gewechselt von 0x01
  delay(10);
  VL6180x_setRegister(VL6180X_SYSTEM_INTERRUPT_CLEAR, 0x07);
  return VL6180x_getRegister(VL6180X_RESULT_RANGE_VAL);
  //	return distance;
